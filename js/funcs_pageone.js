...
{
var $ele=$('<div data-role="collapsible" data-collapsed="false" id="'+tempprod.pdId+'"><h3><div style="text-align: center;font-size:120%"><span id = "name'+tempprod.pdId+'">'+tempprod.pdName+'</span><a href="#" class="ui-btn ui-shadow ui-corner-all ui-icon-delete ui-btn-icon-notext" onclick="remove_object(this.id)" id = "'+tempprod.pdId+'" style="float:right; border:0px;"></a></div></h3><div class="ui-grid-b" style="font-size: 110%;"><div class="ui-block-a"><img src="" class = "imagesOnPageone" id="img' + tempprod.pdId + '" /></div><div class="ui-block-b"><span><span id = "name_'+tempprod.pdId+'">Name:'+tempprod.pdName+'</span><br/><span>Price: Rs. <span  id="mPrice' + tempprod.pdId + '">'+tempprod.mallPrice.toFixed(2)+'</span></span></span></div><div class="ui-block-c"><div class="myInput" id = "myInput"><button class="myInputButtonMinus" id="minus__'+tempprod.pdId+'" onclick="minus_click(this.id)" data-icon="minus">-</button><input type="number" class="myInputBox" id="qt__'+tempprod.pdId+'" onkeyup="key_up(this.id)" onfocusout="focus_out(this.id)"  value="'+tempprod.qty+'" maxlength=""><button class="myInputButtonPlus" id="plus__'+tempprod.pdId+'" onclick="plus_click(this.id)">+</button></div><div style="float: right; height: 70%;"><p style="text-align: right;"><strong>S.Total<br/>Rs. <span id="sTotal' + tempprod.pdId + '">'+tempprod.subTotal.toFixed(2)+'</span></strong></p></div></div></div><div id = "offer'+tempprod.pdId+'" style = "text-shadow: 0 0 15px #000000;font-size:110%;"></div></div>').appendTo(document.getElementById('wrapper'));
$ele.collapsible();
