...
{
var $ele=$('<div data-role="collapsible" data-collapsed="false" id="'+tempprod.pdId+'"><h3><div style="text-align:center" id = "name'+tempprod.pdId+'">'+tempprod.pdName+'</div><a href="#" class="ui-btn ui-shadow ui-corner-all ui-icon-delete ui-btn-icon-notext" onclick="remove_object(this.id)" id = "'+tempprod.pdId+'" style="float:right; border:0px;"></a></h3><div class="ui-grid-b"><div class="ui-block-a"><span><img src="warning.png" class = "imagesOnPageone" id="img' + tempprod.pdId + '" /></span></div><div class="ui-block-b" style="font-size: 130%;"><span> <span id = "name_'+tempprod.pdId+'">Name:'+tempprod.pdName+'</span><br><span>Price: Rs <span id="mPrice' + tempprod.pdId + '">'+tempprod.mallPrice.toFixed(2)+'</span> </span></span></div><div class="ui-block-c"><div class="ui-block-c"><div class="myInput" id = "myInput"><button class="myInputButtonMinus" id="minus__'+tempprod.pdId+'" onclick="minus_click(this.id)" data-icon="minus">-</button><input type="number" class="myInputBox" id="qt__'+tempprod.pdId+'" onkeyup="key_up(this.id)" onfocusout="focus_out(this.id)" value="'+tempprod.qty+'" maxlength=""><button class="myInputButtonPlus" id="plus__'+tempprod.pdId+'" onclick="plus_click(this.id)" >+</button></div><div class = "ui-block-c" style="font-size: 130%;"><p> <strong>Subtotal: Rs <span id="sTotal' + tempprod.pdId + '">'+tempprod.subTotal.toFixed(2)+'</span></strong></p></div></div></div>').appendTo(document.getElementById('wrapper'));
$ele.collapsible();
